...
class Doctor extends Component {
  ...
  AddDoctor(licenceNo, name, phone) {
    this.setState({ loading: true })
    this.state.vaxichain.methods.AddDoctor(licenceNo, name, phone).send({ from: this.state.account })
  ...
  render() {
    return (
      ...
      <div id="content" style={{width:650, paddingLeft:530}}>
        <h1 style={{padding:40,width:750,paddingLeft:120}}>Register Doctor</h1>
        <form onSubmit={(event) => {
          ...
          this.AddDoctor(licenceNo, name, phone)
        }}>
